...
Status: V2.2 Object Detail Pages + Shareable Exhibit Records  
...
Current screenshots document the V2.2 public exhibition UI: overview home, thematic trails, object detail pages, Source Map, Archive Table, and the enhanced Lightbox state.
...
- [object-page-v22.png](docs/screenshots/object-page-v22.png)
- [object-related-v22.png](docs/screenshots/object-related-v22.png)
- [archive-table-object-link-v22.png](docs/screenshots/archive-table-object-link-v22.png)
...
- shareable object detail records for every exhibition object
...
- 90 objects
- 90 object detail pages: `/objects/[id]/`
- 5 exhibition routes
- 5 thematic trails
- Trails page: `/trails/`
...
- Canonical links for home, gallery pages, trail pages, object pages, and source map.
- Open Graph / Twitter card metadata.
- Structured data on homepage (CreativeWork + WebSite) and object pages (VisualArtwork).
...
- V2.2 completed: added 90 object detail pages, Archive Table detail links, Lightbox object-page links, and object-level SEO records.
- V2.3 possible next: source essays, bilingual labels, and route-level bibliography notes.
