...
export const objects: ExhibitionObject[] = [
  ...
  },
  {
    ...
    rightsNote: "Museum collection record verified. Copyright remains with Fan Ho; linked only, image not copied.",
  ...
  },
  {
    ...
    rightsNote: "Gallery/estate trail identified via Blue Lotus and Ocula. Direct reproduction rights are not granted here; linked only, image not copied.",
  ...
  },
  {
    ...
    rightsNote: "Artist project page verified. Direct reproduction rights are not granted here; linked only, image not copied.",
  ...
  },
  {
    ...
    rightsNote: "Project/publication site verified. Direct reproduction rights are not granted here; linked only, image not copied.",
  ...
  },
  {
    ...
    rightsNote: "Photographer-hosted China 1982 trail and Flickr record identified. Flickr indicates all rights reserved; linked only, image not copied.",
  ...
  },
  {
    ...
    rightsNote: "Photographer-hosted China 1982 trail identified, with Flickr as image record path. Direct reproduction rights are not granted here; linked only, image not copied.",
